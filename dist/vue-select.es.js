...
var C = (e, t, s) => t in e ? x(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, f = (e, t) => {
  for (var s in t || (t = {}))
...
import { openBlock as a, createElementBlock as h, createElementVNode as u, resolveDirective as K, normalizeClass as B, renderSlot as r, normalizeProps as d, guardReactiveProps as c, Fragment as A, renderList as L, createTextVNode as v, toDisplayString as D, createBlock as b, resolveDynamicComponent as _, createCommentVNode as O, mergeProps as k, toHandlers as j, withDirectives as w, vShow as T, createVNode as R, Transition as $, withCtx as z, withModifiers as P } from "vue";
const U = {
  props: {
    autoscroll: {
      type: Boolean,
...
const oe = /* @__PURE__ */ S(Z, [["render", ie]]), F = {
  Deselect: W,
  OpenIndicator: oe
}, ne = {
...
https://vue-select.org/api/props.html#getoptionkey`, e, t);
  ...
  ref: "actions",
  class: "vs__actions"
}, ge = ["disabled", "tabindex"], ye = { class: "vs__spinner" }, me = ["id"], be = ["id", "aria-selected", "onMouseover", "onClick"], _e = {
  key: 0,
...
function ve(e, t, s, n, l, i) {
  ...
  return a(), h("div", {
    ...
    u("div", {
      ...
      u("div", ue, [
        (a(!0), h(A, null, L(i.selectedValue, (o, p) => r(e.$slots, "selected-option-container", {
      ...
      u("div", fe, [
        w(u("button", {
          ...
          disabled: s.disabled,
          type: "button",
          tabindex: s.clearButtonTabIndex,
          class: "vs__clear",
    ...
    R($, { name: s.transition }, {
      default: z(() => [
        i.dropdownOpen ? w((a(), h("ul", {
          ...
          role: "listbox",
          tabindex: "-1",
          onMousedown: t[2] || (t[2] = P((...o) => i.onMousedown && i.onMousedown(...o), ["prevent"])),
          onMouseup: t[3] || (t[3] = (...o) => i.onMouseUp && i.onMouseUp(...o))
        }, [
          r(e.$slots, "list-header", d(c(i.scope.listHeader))),
          (a(!0), h(A, null, L(i.filteredOptions, (o, p) => (a(), h("li", {
            ...
            onClick: P((g) => s.selectable(o) ? i.select(o) : null, ["prevent", "stop"])
          }, [
